...
| Вариация | URL | Главный экран | Про нас | Контакты |
|---|---|---|---|---|
| **V1** | `/` | центрированный текст + веер карточек-виджетов | intro · команда · история | сплит: контакты слева, фото и форма справа |
| **V2** | `/v2/` | текст слева + портрет справа + автолента карточек | + отзывы в конце | центр, с фото над формой |
| **V3** | `/v3/` | центр + портрет и стеклянная лента логотипов | команда · принципы · отзывы | центр, тёмная форма без фото |
